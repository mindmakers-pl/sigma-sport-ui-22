            ...
            <SidebarMenu className="gap-1">
              {navigationItems.map((item) => (
                <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton 
                    asChild 
                    className="h-11 text-sidebar-primary-foreground/90 hover:bg-sidebar-primary-foreground/15 hover:text-sidebar-primary-foreground data-[active=true]:bg-sidebar-primary-foreground/20 data-[active=true]:text-sidebar-primary-foreground transition-colors duration-200"
                  >
      ...
      <SidebarFooter className="bg-sidebar-primary border-t border-sidebar-primary-foreground/10">
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton 
              asChild 
              className="h-11 text-sidebar-primary-foreground/90 hover:bg-sidebar-primary-foreground/15 hover:text-sidebar-primary-foreground transition-colors duration-200"
            >
