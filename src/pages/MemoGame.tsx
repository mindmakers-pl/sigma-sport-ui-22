        ...
        <div className="flex-1 flex items-center justify-center p-8">
          <Card className="max-w-2xl w-full p-8 space-y-6">
            <div className="space-y-4">
              <h1 className="text-3xl font-bold">Sigma Memo</h1>
            ...
            <div className="space-y-4 text-base">
              <div className="space-y-2">
                <h3 className="font-semibold text-lg">Jak grać?</h3>
              ...
              <div className="space-y-2 bg-muted/50 p-4 rounded-lg">
                <h3 className="font-semibold">Dlaczego to ważne w sporcie?</h3>
              ...
              <div className="bg-primary/10 p-4 rounded-lg border border-primary/20">
                <p className="text-sm">
                  <strong>Wskazówka:</strong> Pierwsze dwa kwadraty to rozgrzewka - 
        ...
        <div className="flex-1 flex items-center justify-center p-8">
          <Card className="max-w-2xl w-full p-8 space-y-6">
            <div className="text-center space-y-2">
              <h2 className="text-2xl font-bold">Wyniki Sigma Memo</h2>
              <p className="text-muted-foreground">Test pamięci roboczej 2-Back</p>
            </div>
            ...
            <div className="space-y-4 pt-4 border-t">
              <h3 className="font-semibold">Dane HRV (opcjonalne)</h3>
              <div className="grid grid-cols-2 gap-4">
                <div>
